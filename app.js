...
const CLUBS = [
  {
    ...
    initials: 'S',
    players: [
      { number: 1,  name: 'Claudia',           position: 'GK',  nationality: 'Spain' },
      { number: 3,  name: 'Aqilah',        position: 'DEF', nationality: 'Scotland' },
      { number: 4,  name: 'Faith',             position: 'DEF', nationality: 'England' },
      { number: 6,  name: 'Sindhu',     position: 'DEF', nationality: 'Brazil' },
      { number: 12, name: 'Ella',        position: 'DEF', nationality: 'Netherlands' },
      { number: 2,  name: 'Jasmine',             position: 'DEF', nationality: 'England' },
      { number: 35, name: 'Jernise',   position: 'DEF', nationality: 'Ukraine' },
      { number: 8,  name: 'cheyenne',       position: 'MID', nationality: 'Norway' },
      { number: 29, name: 'Ann-Margaret',           position: 'MID', nationality: 'Germany' },
      { number: 41, name: 'Chloe',           position: 'MID', nationality: 'England' },
      { number: 7,  name: 'Sara',           position: 'FWD', nationality: 'England' },
      { number: 9,  name: 'Huiping',         position: 'FWD', nationality: 'Brazil' },
