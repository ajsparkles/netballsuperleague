...
const CLUBS = [
  {
    ...
    initials: 'S',
    players: [
      { number: 1,  name: 'Claudia',           position: 'Defender',  nationality: 'Singapore' },
      { number: 2,  name: 'Aqilah',        position: 'Defender', nationality: 'Singapore' },
      { number: 3,  name: 'Faith',             position: 'Defender', nationality: 'Singapore' },
      { number: 4,  name: 'Sindhu',     position: 'Defender', nationality: 'Singapore' },
      { number: 5, name: 'Ella',        position: 'Mid Court', nationality: 'Singapore' },
      { number: 6, name: 'Arina',        position: 'Mid Court', nationality: 'Singapore' },
      { number: 7,  name: 'Jasmine',             position: 'Mid Court', nationality: 'Singapore' },
      { number: 8, name: 'Jernise',   position: 'Mid Court', nationality: 'Singapore' },
      { number: 9,  name: 'Cheyenne',       position: 'Mid Court', nationality: 'Singapore' },
      { number: 10, name: 'Ann-Margaret',           position: 'Shooter', nationality: 'Singapore' },
      { number: 11, name: 'Chloe',           position: 'Shooter', nationality: 'Singapore' },
      { number: 12,  name: 'Sara',           position: 'Shooter', nationality: 'Singapore' },
      { number: 13,  name: 'Huiping',         position: 'Shooter', nationality: 'Singapore' },
