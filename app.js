...
const CLUBS = [
  {
    ...
    players: [
      ...
      { number: 6,  name: 'Jasmine',             position: 'Mid Court', nationality: 'Singapore' },
      { number: 7, name: 'Jernise',   position: 'Mid Court', nationality: 'Singapore' },
      { number: 8,  name: 'Cheyenne',       position: 'Mid Court', nationality: 'Singapore' },
      { number: 9, name: 'Ann-Margaret',           position: 'Shooter', nationality: 'Singapore' },
      { number: 10, name: 'Chloe',           position: 'Shooter', nationality: 'Singapore' },
      { number: 11,  name: 'Sara',           position: 'Shooter', nationality: 'Singapore' },
      { number: 12,  name: 'Huiping',         position: 'Shooter', nationality: 'Singapore' },
